...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Editar Empleados", pos = wx.DefaultPosition, size = wx.Size( 639,461 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
